...
open class WSTagView: UIView, UITextInputTraits {
    ...
    open var cornerRadius: CGFloat = 3.0 {
        didSet {
            if enableCurvedCorners { return }
            self.layer.cornerRadius = cornerRadius
            setNeedsDisplay()
        }
    }
  
    open var enableCurvedCorners: Bool = true {
        didSet {
    ...
    public init(tag: WSTag) {
        ...
        self.layer.cornerRadius = enableCurvedCorners ? self.frame.height/2.0 : cornerRadius
    ...
    open override func layoutSubviews() {
        ...
        //if enableCurvedCorners { self.layer.cornerRadius = self.frame.height/2.0 }
    }
